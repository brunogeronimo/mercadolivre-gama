...
function up_7002_7010($_prefix,$_link,$_engine)
{
    ...
    $commands[] = array(1060,"UPDATE `".DBManager::RealEscape($_prefix)."visitors` SET `closed`=0 WHERE `closed`<".(time()-Server::$Configuration->File["timeout_track"]) .";");
...
function up_6005_6100($_prefix,$_link,$_engine)
{
    ...
    $commands[] = array(1054,"ALTER TABLE `".DBManager::RealEscape($_prefix)."tickets` CHANGE `creation_type` `channel_type` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0';");
