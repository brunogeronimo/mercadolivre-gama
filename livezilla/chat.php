...
$html = str_replace("<!--logol-->","<img src=\"". Server::$Configuration->File["gl_cali"]."\" border=\"0\">",$html);
...
{
    $html = str_replace("<!--widget-->","<script type=\"text/javascript\" src=\"./script.php?id=".$cid."\"></script>",$html);
}
else
{
