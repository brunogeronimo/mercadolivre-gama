...
<div id="lz_chat_overlay_main" class="lz_chat_base notranslate" style="direction:<!--dir-->;border-radius:6px;border:1px solid <!--pc-->;" onclick="lz_chat_switch_options_table(true);">
    <div class="lz_overlay_chat_gradient" class="unselectable">
        <div id="lz_chat_overlay_text" class="unselectable "><!--text--></div>
        <!--lz_chat_min-->
    </div>
    <div id="lz_chat_content">
        ...
        <div id="lz_chat_data_form" class="lz_chat_module">
            ...
            <div id="lz_chat_data_form_inputs">
                <div>
                    ...
                    <br>
                    <div id="lz_chat_overlay_data_form_ok_button" class="lz_overlay_chat_button unselectable lz_overlay_br_five" style="background:<!--pc-->;" onclick="lz_chat_data_form_result();"></div>
                </div>
            </div>
        </div>
        ...
        <div id="lz_chat_overlay_ticket" class="lz_chat_module">
            ...
            <div class="lz_overlay_chat_button unselectable lz_overlay_br_five" style="background:<!--pc-->;" onclick="lz_chat_data_form_result();"><!--lang_client_back--></div>
        </div>
		<div id="lz_overlay_module_chat" class="lz_chat_module">
            <div id="lz_chat_state_bar" class="lz_chat_header">
               <div id="lz_chat_options_table" class="unselectable" style="display:none;border: 1px solid <!--pc-->;">
                ...
                <div id="lz_chat_operator_details" class="unselectable">
                    <div>
            ...
            <div id="lz_chat_overlay_bottom">
                <div>
                    <div id="lz_chat_bot_reply_loading" style="display:none;" class="lz_anim_loading">
    ...
    <div id="lz_chat_apa" class="lz_overlay_chat_footer unselectable lz_overlay_chat_options_link"><!--param--></div>
</div>
