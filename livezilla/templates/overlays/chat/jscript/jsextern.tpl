...
try
{
    ...
    style.innerHTML += '.lz_chat_link{color: <!--bgcd--> !important;}';
    style.innerHTML += '.lz_chat_file{color: <!--bgcd--> !important;}';
...
function lz_chat_update_css()
{
    ...
    lz_overlay_chat.lz_livebox_div.style.zIndex = (lz_chat_state_expanded) ? 20000010 : 9999;
