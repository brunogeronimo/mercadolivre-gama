...
DatabaseManagerClass.prototype.CreateTables = function(_caller,_dl) {
    ...
    pd['p_operators_0_fullname'] = _caller.m_Data.fullname;
    ...
    pd['p_operators_0_password'] = CryptoJS.MD5(_caller.m_Data.password).toString();
    pd['p_operators_0_permissions'] = '2220222101000210112121111111111111011111011011033';
    ...
    pd['p_groups_0_functions'] = '111101';
    ...
    pd['p_groups_0_chat_vouchers_required'] = 'a:0:{}';
    pd['p_groups_0_pre_js'] = '';
    pd['p_groups_0_post_js'] = '';
    pd['p_groups_0_pos'] = '0';
    ...
    pd['p_db_pm_g_c3VwcG9ydA==_DE_welcmb'] = '';
    ...
    pd['p_db_pm_g_c3VwcG9ydA==_DE_etr'] = '';
    ...
    pd['p_db_pm_g_c3VwcG9ydA==_EN_welcmb'] = 'SGVsbG8sIG15IG5hbWUgaXMgJW9wZXJhdG9yX25hbWUlLiBQbGVhc2UgZXhwZWN0IG15IHRlbGVwaG9uZSBjYWxsIGluIHRoZSBuZXh0IGZldyBzZWNvbmRzLiBEdXJpbmcgb3VyIHRlbGVwaG9uZSBjb252ZXJzYXRpb24sIGZlZWwgZnJlZSB0byBwYXNzIG1lIGluZm9ybWF0aW9uIGFuZCBmaWxlcyB0aHJvdWdoIHRoaXMgY2hhdC4=';
    ...
    pd['p_db_pm_g_c3VwcG9ydA==_EN_etr'] = '';
...
DatabaseManagerClass.prototype.UpdateTables = function(_caller,_dl) {
    ...
    $.post( "./server.php", pd)
        ...
        .done(function( data ) {
            ...
            if(resultcode == -1)
            {
                sresponsetxt = 'invalid response:' + data;
            }
            else if(resultcode == '1')
            {
                switchLoading(false);
...
function ServerInstallClass() {
    ...
    this.m_Data = {username:'administrator',fullname:'',email:'',password:'',setCookies:true,cookieLifetime:100,maskIP:true,maskIPFormat:1,respectDNT:false,dbExtension:'mysqli',dbEngine:'MyISAM',dbHost:'localhost',dbUser:'root',dbPassword:'',dbName:'',dbPrefix:'lz_'};
}
...
ServerInstallClass.prototype.ValidateStep = function(forward) {
    ...
    if(this.m_InstallSteps[this.m_CurrentStep] == 'admin'){
        ...
        if(forward && $('#tb_fullname').val().length < 2)
            alertFieldId += ',#tb_fullname';
        ...
        this.m_Data.fullname = $('#tb_fullname').val();
...
ServerInstallClass.prototype.GetInstallContent = function() {
    ...
    if(this.m_InstallSteps[this.m_CurrentStep] == 'comp'){
        if(!lz_update_mode)
        {
            contentHtml = '<div class="top-space text-xxxl text-gray">'+lz_index_language['install_start_header']+'</div><br>'+lz_index_language['table_create']
        ...
        {
            contentHtml = '<div class="top-space text-xxxl text-gray">Thanks for Updating!</div><br>'+lz_index_language['table_update']+'<br><br>'
        ...
        contentHtml = '<div class="top-space text-xxxl text-gray">'+lz_index_language['install_finish_header']+'</div><br>'+lz_index_language['install_finish_text']+'<br><br>';
    ...
    else if(this.m_InstallSteps[this.m_CurrentStep] == 'admin')
    {
        ...
        contentHtml += '<tr><td><label>'+lz_index_language['username']+'</label></td><td>' + lzm_inputControls.createInput('tb_username', '', this.m_Data.username, '', '', 'text', '') + '</td></tr>';
        contentHtml += '<tr><td><label>'+lz_index_language['name']+'</label></td><td>' + lzm_inputControls.createInput('tb_fullname', '', this.m_Data.fullname, '', '', 'text', '') + '</td></tr>';
        contentHtml += '<tr><td><label>'+lz_index_language['email']+'</label></td><td>' +  lzm_inputControls.createInput('tb_email', '', this.m_Data.email, '', '', 'text', '') + '</td></tr>';
        ...
        contentHtml += '</table><hr><table class="index_form_table">';
        contentHtml += '<tr><td><label>'+lz_index_language['respect_dnt']+'</label></td><td>' +  lzm_inputControls.createCheckbox('cb_respect_dnt', '', this.m_Data.respectDNT) + '</td></tr></table><br>';
    }
