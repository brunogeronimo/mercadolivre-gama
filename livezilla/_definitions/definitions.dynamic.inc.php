...
define("TEMPLATE_HTML_EYE_CATCHER_BUBBLE",PATH_TEMPLATES . "overlays/chat/eyecatcher_bubble.tpl");
define("TEMPLATE_HTML_EYE_CATCHER_IMAGE",PATH_TEMPLATES . "overlays/chat/eyecatcher_image.tpl");
...
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_STATUS",PATH_TEMPLATES . "overlays/chat/messagestatus.tpl");
define("TEMPLATE_HTML_MESSAGE_OVERLAY_CHAT_PICTURE",PATH_TEMPLATES . "overlays/chat/messagepicture.tpl");
...
define("TEMPLATE_SCRIPT_GLOBAL",PATH_TEMPLATES . "jscript/jsglobal.js");
define("TEMPLATE_SCRIPT_INVITATION",PATH_TEMPLATES . "invitations/");
define("TEMPLATE_SCRIPT_OVERLAYS",PATH_TEMPLATES . "overlays/");
