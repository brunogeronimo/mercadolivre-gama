...
function ChatEditorClass(editor) {
    this.editor = editor;
    this.isBold = false;
    this.isItalic = false;
...
ChatEditorClass.prototype.init = function(loadedValue, caller, cpId) {
    ...
    if(lzm_chatDisplay.ChatsUI.EditorBlocked && lzm_chatDisplay.selected_view == 'mychats')
        return;

    cpId = (typeof cpId != 'undefined') ? cpId : ChatManager.ActiveChat;
    this.removeEditor();
...
ChatEditorClass.prototype.showHTML = function() {
    ...
    var that = this;
    var editorControl = lzm_inputControls.createArea('editor-edit-html', '', '','HTML:','width:1000px;height:500px;');
