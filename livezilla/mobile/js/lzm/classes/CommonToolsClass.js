...
CommonToolsClass.prototype.getTicketSalutationFields = function(ticket, messageNo) {
    ...
    if (savedSalutations == null || savedSalutations == '') {
        initialSalutations[DataEngine.userLanguage] = {'first name': [0], 'last name': [0],
...
CommonToolsClass.prototype.replaceChatPlaceholders = function(_systemId, resourceText) {
    ...
    try
    {
        ...
        var pageTitle = (visitorBrowser != null && visitorBrowser.h2.length > 0) ? visitorBrowser.h2[visitorBrowser.h2.length - 1].title : '';
        var url = (visitorBrowser != null && visitorBrowser.h2.length > 0) ? visitorBrowser.h2[visitorBrowser.h2.length - 1].url : '';
        var searchString = '';
...
CommonToolsClass.prototype.IsWildcardMatch = function(_template,_comparer,_ignoreStartAndEnd){
    if(!d(_ignoreStartAndEnd))
        _ignoreStartAndEnd = false;
