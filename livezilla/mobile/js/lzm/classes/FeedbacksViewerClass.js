...
FeedbacksViewer.prototype.createFooterLine = function(logic){
    ...
    if(!logic)
    {
        ...
        footLineHtml += lzm_inputControls.createButton('feedbacks-page-all-backward', 'feedbacks-list-page-button' + leftDisabled, 'pageFeedbacksViewer(1);', '',
            ...
            lzm_inputControls.createButton('feedbacks-page-one-backward', 'feedbacks-list-page-button' + leftDisabled, 'pageFeedbacksViewer(' + (FeedbacksViewer.Page - 1) + ');', '', '<i class="fa fa-backward"></i>', 'r',{'border-left-width': '1px'}) +
            '<span style="padding: 0 15px;">' + tid('page_of_total',[['<!--this_page-->', FeedbacksViewer.Page], ['<!--total_pages-->', FeedbacksViewer.PagesTotal]]) + '</span>' +
            lzm_inputControls.createButton('feedbacks-page-one-forward', 'feedbacks-list-page-button' + rightDisabled, 'pageFeedbacksViewer(' + (FeedbacksViewer.Page + 1) + ');', '', '<i class="fa fa-forward"></i>', 'l',{'border-right-width': '1px'}) +
            lzm_inputControls.createButton('feedbacks-page-all-forward', 'feedbacks-list-page-button' + rightDisabled, 'pageFeedbacksViewer(' + FeedbacksViewer.PagesTotal + ');', '', '<i class="fa fa-fast-forward"></i>', 'r',{'border-left-width': '1px'});
